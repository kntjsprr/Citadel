...
namespace Citadel
{
    class CitadelMain
    {
        ...
        public CitadelMain(byte[] encryptionKey, IProgress<int> progressReporter = null, int chunkSize = 1572864)
        {
        ...
        public string TransformFile(string filePath, string savePath, string extension = null)
        {
        ...
        /// <exception cref="OperationCanceledException">Operation canceled.</exception> 
        public string RestoreFile(string filePath, string savePath)
        {
